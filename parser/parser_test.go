...
func TestGetNode(t *testing.T) {
	wf := parser.NewWorkflow(data, nil, nil, nil, nil, nil, nil)
...
func TestCancel(t *testing.T) {
	...
	wf := parser.NewWorkflow(data, func(m any, model, phoneNumber, sessionId, cacheFolder, preferenceFolder *string) {
		if m != nil {
